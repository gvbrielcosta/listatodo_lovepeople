...
import 'package:listatodo_lovepeople/pages/removTarefa/removTarefa.dart';
                        ...
                        itemBuilder: (context, index) {
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              trailing: RemovTarefa(
                                onRemover: () =>
                                    _removerTarefa(todoList[index]),
                                confirmarRemover: 'Confirma a remoção?',
                                todo: todoList[index],
                              ),
                              title: Text(
